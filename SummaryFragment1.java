...
public class SummaryFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_summary_fragment1, container, false);
        ...
        ArrayList<Batsman> ftbat  = extras.getParcelableArrayList("ftbat");
        ArrayList<Bowler> stball  = extras.getParcelableArrayList("stball");

//        String name = al22.get(0).getBowlerName();
//
//        Toast.makeText(getActivity(),name+"",Toast.LENGTH_LONG).show();

        adapterBat = new BatsmanAdapter(ftbat);
        adapterBall = new BowlerAdapter(stball);
